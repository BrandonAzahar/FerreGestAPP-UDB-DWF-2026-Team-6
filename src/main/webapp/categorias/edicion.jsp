                ...
                <div class="card-body">
                    <form action="categorias" method="POST" onsubmit="return validarFormulario();">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" value="${categoria.nombre}" required maxlength="100">
                        </div>
                        
                        <div class="mb-3">
                            <label for="descripcion" class="form-label">Descripción</label>
                            <textarea class="form-control" id="descripcion" name="descripcion" rows="3" maxlength="255">${categoria.descripcion}</textarea>
                        </div>
